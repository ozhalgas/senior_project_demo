...
class PanelWidget extends StatefulWidget {
  const PanelWidget({ Key? key, required this.controller, /*required this.panelController*/ required this.shop}) : super(key: key);
  ...
  @override
  State<PanelWidget> createState() => _PanelWidgetState(shop, controller);
}
...
class _PanelWidgetState extends State<PanelWidget> {
  ...
  Shop shop;
  _PanelWidgetState(this.shop, this.controller);
